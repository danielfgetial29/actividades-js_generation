...
if (require.main === module) {
  const pruebas = [
    {
      nombre: "Prueba 1: Sumar múltiples enteros positivos",
      func: probarSumarMultiplesEnterosPositivos,
    },
    {
      nombre: "Prueba 2: Sumar múltiples números complicados",
      func: probarSumarMultiplesNumerosComplicados,
    },
    {
      nombre: "Prueba 3: Multiplicar múltiples enteros positivos",
      func: probarMultiplicarMultiplesEnterosPositivos,
    },
    {
      nombre: "Prueba 4: Multiplicar múltiples números complicados",
      func: probarMultiplicarMultiplesNumerosComplicados,
    },
    { nombre: "Prueba 5: ¿Seis es par?", func: probarSiSeisEsPar },
    {
      nombre: "Prueba 6: ¿-3.8 es par?",
      func: probarSiMenosTresPuntoOchoEsPar,
    },
    { nombre: "Prueba 7: ¿Tres es entero?", func: probarSiTresEsEntero },
    {
      nombre: "Prueba 8: ¿7.3 es entero?",
      func: probarSiSietePuntoTresEsEntero,
    },
  ];
  ...
  if (aprobadas === total) {
    ...
    console.log(
      "Algunas pruebas fallaron. Revisa tus funciones de JavaScript.",
    );
  }
}
